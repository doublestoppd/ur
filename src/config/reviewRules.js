  ...
  var REVIEW_RULES = [
    {
      ...
      fields: ['Account', 'Patient ID', 'Patient name', 'Payer category', 'Admit', 'Discharge', 'LOS hours', 'LOS days', 'Excess days'],
      sourceRefs: ['R1', 'R2'],
    ...
    {
      id: 'RQ_OS_24', version: '1.2', priority: 30,
    ...
    {
      id: 'RQ_OS_36', version: '1.2', priority: 25,
      name: 'Observation longer than 36 hours',
      classification: C.OPERATIONAL,
      trigger: 'Observation duration greater than 36 hours.',
      definition: 'Escalated observation-duration flag. Open accounts are included, measured to the as-of datetime. The work list covers stays that overlap the period even partly and stays counted in this period\'s discharged-stay figures (v1.2).',
    ...
    {
      id: 'RQ_OS_48', version: '1.2', priority: 10,
      name: 'Observation longer than 48 hours',
      classification: C.OPERATIONAL,
      trigger: 'Observation duration greater than 48 hours.',
      definition: 'High-priority prolonged observation flag. Open accounts are included, measured to the as-of datetime. The work list covers stays that overlap the period even partly and stays counted in this period\'s discharged-stay figures (v1.2).',
    ...
    },
    {
      ...
      thresholds: [],
      fields: ['OS account', 'IP account', 'Patient ID', 'Patient name', 'Payer category', 'OS hours before conversion', 'Gap minutes', 'Link confidence', 'Episode ID'],
      sourceRefs: ['HOSP'],
      notes: DISCLAIMER,
    ...
    },
    {
      ...
      thresholds: [],
      fields: ['IP account', 'SB account', 'Patient ID', 'Patient name', 'Payer category', 'Gap minutes', 'Link confidence', 'Episode ID'],
      sourceRefs: ['HOSP'],
      notes: DISCLAIMER,
    ...
    },
    {
      ...
      thresholds: [],
      fields: ['SB account', 'IP account', 'Patient ID', 'Patient name', 'Payer category', 'Gap minutes', 'Link confidence', 'Episode ID'],
      sourceRefs: ['HOSP'],
    ...
    },
    {
      ...
      fields: ['Account', 'Patient ID', 'Patient name', 'Payer category', 'Admit', 'Discharge', 'Midnights crossed', 'LOS hours'],
      sourceRefs: ['R5'],
    ...
    },
    {
      ...
      fields: ['Account', 'Patient ID', 'Patient name', 'Payer category', 'Admit', 'Discharge', 'LOS hours', 'Midnights crossed'],
      sourceRefs: ['HOSP'],
      notes: DISCLAIMER,
    ...
    },
    {
      ...
      fields: ['New IP account', 'Prior episode ID', 'Prior final discharge', 'Patient ID', 'Patient name', 'Payer category', 'Days between', 'Prior disposition'],
      sourceRefs: ['HOSP'],
    ...
    },
    {
      ...
      fields: ['Account', 'Patient ID', 'Patient name', 'Service', 'Discharge code', 'Issue', 'Candidate accounts', 'Gap minutes'],
      sourceRefs: ['HOSP'],
    ...
    },
    {
      ...
      thresholds: [],
      fields: ['Account', 'Patient ID', 'Service', 'Issue', 'Severity', 'Diagnostic rule'],
      sourceRefs: ['HOSP'],
