...
var ROWS = [
  ...
  ['1001', 'A101', 'TEST, ALPHA', 'OS', '08/03/2026', 1015, '08/04/2026', 1432, 'MCR', 'B', 1],
  ['1001', 'A102', 'TEST, ALPHA', 'IP', '08/04/2026', 1436, '08/08/2026', 1100, 'MCR', 'Q', 1],
  ['1001', 'A103', 'TEST, ALPHA', 'SB', '08/08/2026', 1104, '08/15/2026', 930, 'MCR', 'V', 1],
  ['1001', 'A104', 'TEST, ALPHA', 'IP', '08/15/2026', 934, '08/18/2026', 1200, 'MCR', 'H', 1],

  /* T04 - OS -> SB within tolerance */
  ['1002', 'A201', 'TEST, BRAVO', 'OS', '08/05/2026', 800, '08/06/2026', 900, 'BCBS', 'Q', 2],
  ['1002', 'A202', 'TEST, BRAVO', 'SB', '08/06/2026', 905, '08/12/2026', 1000, 'BCBS', 'H', 2],

  /* T05 - transition code with no successor */
  ['1003', 'A301', 'TEST, CHARLIE', 'IP', '08/02/2026', 700, '08/06/2026', 1500, 'MCR', 'Q', 1],

  /* T06 - two plausible successors: must stay unlinked */
  ['1004', 'A401', 'TEST, DELTA', 'IP', '08/04/2026', 900, '08/05/2026', 1000, 'MA', 'Q', 1],
  ['1004', 'A402', 'TEST, DELTA', 'SB', '08/05/2026', 1010, '08/09/2026', 1100, 'MA', 'H', 1],
  ['1004', 'A403', 'TEST, DELTA', 'SB', '08/05/2026', 1020, '08/10/2026', 1100, 'MA', 'H', 1],

  /* T07 - same-day true return: two separate IP episodes, never merged */
  ['1005', 'A501', 'TEST, ECHO', 'IP', '08/07/2026', 800, '08/07/2026', 1200, 'BCBS', 'H', 3],
  ['1005', 'A502', 'TEST, ECHO', 'IP', '08/07/2026', 1800, '08/09/2026', 1000, 'BCBS', 'H', 3],

  /* T08 - 30-day readmission at exactly 17 days */
  ['1006', 'A601', 'TEST, FOXTROT', 'IP', '08/01/2026', 900, '08/03/2026', 1100, 'MCR', 'H', 1],
  ['1006', 'A602', 'TEST, FOXTROT', 'IP', '08/20/2026', 1100, '08/22/2026', 900, 'MCR', 'H', 1],

  /* T10 - unrecognized service code */
  ['1007', 'A701', 'TEST, GOLF', 'ZZ', '08/05/2026', 1000, '08/05/2026', 1400, 'BCBS', 'H', 3],
  ...
  ['1011', 'B101', 'TEST, KILO', 'IP', '08/10/2026', 600, '08/11/2026', 1000, 'MCR', 'H', 1],

  /* T15 - Medicare observation at 31 hours: MOON candidate, >24h, not >36h */
  ['1012', 'B201', 'TEST, LIMA', 'OS', '08/12/2026', 800, '08/13/2026', 1500, 'MCR', 'H', 2],

  /* T16 - open inpatient encounter */
  ['1013', 'B301', 'TEST, MIKE', 'IP', '08/28/2026', 900, '', '', 'MCR', '', 1],

  /* T17 - exact duplicate account, twice */
  ['1014', 'B401', 'TEST, NOVEMBER', 'IP', '08/09/2026', 900, '08/10/2026', 900, 'BCBS', 'H', 1],
  ['1014', 'B401', 'TEST, NOVEMBER', 'IP', '08/09/2026', 900, '08/10/2026', 900, 'BCBS', 'H', 1],

  /* Mortality and payer coverage */
  ['1015', 'B501', 'TEST, OSCAR', 'IP', '08/14/2026', 700, '08/16/2026', 1300, 'MA', 'E', 1],
  ['1016', 'B601', 'TEST, PAPA', 'OS', '08/18/2026', 1200, '08/21/2026', 1200, 'SP', 'H', 2],
  ['1017', 'B701', 'TEST, QUEBEC', 'IP', '08/22/2026', 1500, '08/25/2026', 1000, 'MCD', 'A', 4]
];
